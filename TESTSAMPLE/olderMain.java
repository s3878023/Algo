...
//            int x = random.nextInt(10000000); // Random X coordinate within 0 to 100,000,000
//            int y = random.nextInt(10000000); // Random Y coordinate within 0 to 100,000,000
//            List<String> services = Arrays.asList("RandomService1", "RandomService2"); // Example services
...
//                        System.out.println("X: " + place.getX() + ", Y: " + place.getY() + ", Services: " + place.getServices());
//                    }
//                    break;
//                case 5:
...
//
//class Map2D {
//    private java.util.Map<Integer, java.util.Map<Integer, List<Place>>> grid;
//
//    public Map2D() {
//        grid = new java.util.HashMap<>();
//    }
//
...
//        if (grid.containsKey(gridX) && grid.get(gridX).containsKey(gridY)) {
//            List<Place> places = grid.get(gridX).get(gridY);
//            places.removeIf(place -> place.getX() == x && place.getY() == y);
//            if (places.isEmpty()) {
...
//            List<String> services = Arrays.asList(serviceType); // Example services
//            map.addPlace(x, y, services);
//            System.out.println("Added!");
//        }
//
...
//            items[size++] = t;
//        } else {
//            // Handle case where array is full
//            // For example, you could resize the array or throw an exception
//        }
//    }
//
//    @Override
...
//
//class Map2D {
//    private final Map<Integer, Map<Integer, List<Place>>> grid;
//
//    public Map2D() {
//        grid = new HashMap<>();
//    }
...
//    public List<Place> searchPlaces(int minX, int minY, int maxX, int maxY) {
//        List<Place> result = new ArrayList<>();
//        for (Integer gridX : grid.keySet()) {
//            for (Integer gridY : grid.get(gridX).keySet()) {
//                if (gridX * 100000 <= maxX && (gridX + 1) * 100000 >= minX &&
//                        gridY * 100000 <= maxY && (gridY + 1) * 100000 >= minY) {
//                    for (Place place : grid.get(gridX).get(gridY)) {
//                        if (place.getX() >= minX && place.getX() <= maxX &&
//                                place.getY() >= minY && place.getY() <= maxY) {
//                            result.add(place);
//                            if (result.size() == 50) {
